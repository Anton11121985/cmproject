...
public class AttachmentDecisionScriptlet extends JRDefaultScriptlet {
	...
	public String getAttachmentText(Object objDocId){
		...
		for(DomainObject o : attachmentService.findAttachmentDomainObjectsFor(docId, "F_ContentRT_Dec")){
			if(buffer.length() > 0){
				buffer.append("\n");
			}
			try{
